function [] = FitPolynomials(MainPath,ModelName,Modelpath,PolyFolder,Bool_RunMA,muscleNames)
...
MA.hip.rot = importdata([MA_path,'/',SubjPre '_MuscleAnalysis_MomentArm_hip_rotation_r.sto']);
MA.knee.flex = importdata([MA_path,'/',SubjPre '_MuscleAnalysis_MomentArm_knee_angle_r.sto']);

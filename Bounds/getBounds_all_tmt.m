...
% Tmt
bounds.Qdots.upper(jointi.tmt.l) = 13;
bounds.Qdots.lower(jointi.tmt.l) = -13;
bounds.Qdots.upper(jointi.tmt.r) = 13;
bounds.Qdots.lower(jointi.tmt.r) = -13;
% We adjust some bounds when we increase the speed to allow for the
% generation of running motions.
if v_tgt > 1.33
    % Pelvis tx
...
% Tmt
bounds.Qdotdots.upper(jointi.tmt.l) = 500;
bounds.Qdotdots.lower(jointi.tmt.l) = -500;
bounds.Qdotdots.upper(jointi.tmt.r) = 500;
bounds.Qdotdots.lower(jointi.tmt.r) = -500;

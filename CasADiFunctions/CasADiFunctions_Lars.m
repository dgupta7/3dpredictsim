...
% Date: 12/19/2018
%
% Based on CasADiFunctions_all_mtp_createDefault_SensitivityMTParam.m version of 7 oct 2020
% Changes made by Lars D'Hondt
%
...
MuscModelAsmp = [0,1];     % 0: musc width = cst, 1: pennation angle = cst
...
for i = 1:nit
    ...
    elseif(MuscMoAsmp ==1)
        S.CasadiFunc_Folders = ['Casadi_s1Pog_MuscModel_alphaCst'];
    end
...
%     MTscale = SCinfo.ScaleSol(iSc,:);
    ...
    addpath(genpath(fullfile(pathRepo,'MuscleModel')));

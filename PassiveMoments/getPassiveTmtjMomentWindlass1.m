function [M, varargout] = getPassiveTmtjMomentWindlass1(q_tmt,qdot_tmt,q_mtp,kTMT_li,kTMT_PF,dTMT,subject,cWL)
...
F_PF = k_PF*dl_PF;
M_PF = F_PF*h - kTMT_li*q_tmt_0 ; % moment from PF elongation

M_PF = M_PF .*( tanh( M_PF )+1 )/2;

function [R] = f_LoadSim_Gait92_tmt_v2(ResultsFolder,loadname)
...
if writeIKmotion
    ...
    JointAngle.labels = {'time','pelvis_tilt','pelvis_list',...
        ...
        'knee_angle_l','knee_angle_r','ankle_angle_l','ankle_angle_r',...
        'subtalar_angle_l','subtalar_angle_r','tmt_angle_l','tmt_angle_r','mtp_angle_l','mtp_angle_r',...

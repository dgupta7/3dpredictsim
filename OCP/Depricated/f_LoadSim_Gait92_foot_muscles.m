function [R] = f_LoadSim_Gait92_foot_muscles(ResultsFolder,loadname)
...
for k=1:N
    for j=1:d
        ...
        v_PIM_l = f_getPFvelocity(q_col_opt_unsc.rad(count,jointi.mtj.l),...
            qdot_col_opt_unsc.rad(count,jointi.mtj.l),q_col_opt_unsc.rad(count,jointi.mtp.l),...
            qdot_col_opt_unsc.rad(count,jointi.mtp.l));
        v_PIM_r = f_getPFvelocity(q_col_opt_unsc.rad(count,jointi.mtj.r),...
            qdot_col_opt_unsc.rad(count,jointi.mtj.r),q_col_opt_unsc.rad(count,jointi.mtp.r),...
...
%             (Qs_GC(i,jointi.mtj.r)*pi/180,Qdots_GC(i,jointi.mtj.r)*pi/180,...
...
%         F_PF(i) = F_PFi;
        ...
        [~,M_mtpi, M_PFi,M_lii,~,F_PFi,l_PFi,MA_PFi,~,h_fai,l_fai] = ...
                getPassiveMtjMomentWindlass_v3(Qs_GC(i,jointi.mtj.r)*pi/180,...
                Qdots_GC(i,jointi.mtj.r)*pi/180,...

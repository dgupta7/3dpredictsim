function [] = f_PredSim_Gait92_mtj_PIM(S)
...
for j=1:d
    ...
    Tau_passj.tmt.l = f_passiveWLTorques_mtj_PIM(Qskj_nsc(jointi.tmt.l,j+1),...
        Qdotskj_nsc(jointi.tmt.l,j+1),Qskj_nsc(jointi.mtp.l,j+1),F_PIM.l);
    Tau_passj.tmt.r = f_passiveWLTorques_mtj_PIM(Qskj_nsc(jointi.tmt.r,j+1),...
        Qdotskj_nsc(jointi.tmt.r,j+1),Qskj_nsc(jointi.mtp.r,j+1),F_PIM.r);

    Tau_passj.mtp.all(1) = Tau_passj.mtp.all(1) +...
        f_passiveWLTorques_mtp_PIM(Qskj_nsc(jointi.tmt.l,j+1),...
        Qdotskj_nsc(jointi.tmt.l,j+1),Qskj_nsc(jointi.mtp.l,j+1),F_PIM.l);
    Tau_passj.mtp.all(2) = Tau_passj.mtp.all(2) +...
        f_passiveWLTorques_mtp_PIM(Qskj_nsc(jointi.tmt.r,j+1),...
        Qdotskj_nsc(jointi.tmt.r,j+1),Qskj_nsc(jointi.mtp.r,j+1),F_PIM.r);
    ...
    v_PIM_l = f_getPFvelocity(Qskj_nsc(jointi.tmt.l,j+1),Qdotskj_nsc(jointi.tmt.l,j+1),...
        Qskj_nsc(jointi.mtp.l,j+1),Qdotskj_nsc(jointi.mtp.l,j+1));
    P_PIM_l = -v_PIM_l*F_PIM.l;
    
    v_PIM_r = f_getPFvelocity(Qskj_nsc(jointi.tmt.r,j+1),Qdotskj_nsc(jointi.tmt.r,j+1),...

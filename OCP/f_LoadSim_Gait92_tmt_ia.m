    function [R] = f_LoadSim_Gait92_tmt_ia(ResultsFolder,loadname)
...
if strcmp(S.ExoController,'Ideal Assistance')
    ExoVect_opt =reshape(w_opt(starti:starti+(2*N)-1),2,N);
    starti = starti+(2*N);
end
...
% Exoskeleton torque
if strcmp(S.ExoController,'Ideal Assistance')
    ExoVect_opt_nsc = ExoVect_opt*scaling.T_exo_ankle;
    ExoVect = ExoVect_opt_nsc; % Keep existing name instead of structurized name
end

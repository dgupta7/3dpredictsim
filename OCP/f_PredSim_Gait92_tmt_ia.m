function [] = f_PredSim_Gait92_tmt_ia(S)

% With ideal assistance torque ankle exoskeleton.
...
if strcmp(S.ExoController,'s1 Pog')
    ExoVect_nsc = GetExoTorques(S,pathRepo,N);
end
...
for j=1:d
    ...
    Texok_nsc = Texok*scaling.T_exo_ankle;
...
Sopt = S;
if strcmp(S.ExoController,'s1 Pog')
    ExoVect = ExoVect_nsc; % So it still works for the experimantal ExoVect
end
if strcmp(S.ExoController,'Ideal Assistance')
    ExoVect = -ones(2,N); % Return something, to keep LoadSim compatible
end

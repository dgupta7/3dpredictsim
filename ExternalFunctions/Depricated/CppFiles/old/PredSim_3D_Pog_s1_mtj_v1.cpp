...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::Body* central_foot_l; // This is the fusion of metatarsi, cuboid, navicular and cuneiform bones and their surrounding tissue.
	OpenSim::Body* toes_r;
	OpenSim::Body* toes_l;
	OpenSim::Body* torso;
	...
	central_foot_l = new OpenSim::Body("central_foot_l", 0.5417, Vec3(0.03937, -0.01465, -0.0018528), Inertia(0.0013620, 0.002204, 0.0019264, 0, 0, 0));
	...
	midtarsal_l = new PinJoint("midtarsal_l", *calcn_l, Vec3(0.078023, 0.025452, 0.0068103), Vec3(0), *central_foot_l, Vec3(0), Vec3(0));
	midtarsal_r = new PinJoint("midtarsal_r", *calcn_r, Vec3(0.078023, 0.025452, -0.0068103), Vec3(0), *central_foot_r, Vec3(0), Vec3(0));
	mtp_l = new PinJoint("mtp_l", *central_foot_l, Vec3(0.0853859, -0.02728, -0.00779737), Vec3(0), *toes_l, Vec3(0), Vec3(0));
	...
	model->addBody(central_foot_l);	model->addJoint(midtarsal_l);
	...
	HC_2_l = new HuntCrossleyForce_smooth("sphere_2_l", "calcn_l", locSphere_2_l, radiusSphere_s2,
		stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
	HC_3_l = new HuntCrossleyForce_smooth("sphere_3_l", "central_foot_l", locSphere_3_l, radiusSphere_s3,
		stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
	HC_4_l = new HuntCrossleyForce_smooth("sphere_4_l", "central_foot_l", locSphere_4_l, radiusSphere_s4,
		stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
	...
	HC_3_l->connectSocket_body_sphere(*central_foot_l);
	model->addComponent(HC_4_l);
	HC_4_l->connectSocket_body_sphere(*central_foot_l);
	...
	int ncentral_foot_l = model->getBodySet().get("central_foot_l").getMobilizedBodyIndex();
	...
	appliedBodyForces[ncentral_foot_l] = appliedBodyForces[ncentral_foot_l] + GRF_3_l + GRF_4_l;

...
constexpr int NR = ndof + 5 * 3 + 6 + 9 + 3;   // # joint origins + GRFs
...
int F_generic(const T** arg, T** res) {
	...
	Vec3 st_Ankle = Vec3(-0.10501355, -0.17402245, 0.97912632);
	...
	/// ankle axis in ground ref (40-42)
	for (int i = 0; i < nc; ++i) {
		res[0][i + ndof + nc * 10] = value<T>(st_Ankle_Gr[i]);
	}

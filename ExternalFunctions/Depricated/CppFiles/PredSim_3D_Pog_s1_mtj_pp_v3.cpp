...
int F_generic(const T** arg, T** res) {
	...
	tibia_l = new OpenSim::Body("tibia_l", mTibia, COMTibia, ITibia);
	...
	calcn_l = new OpenSim::Body("calcn_l", 0.4217, Vec3(0.03628, 0.017101, 0.004057), Inertia(8.5663e-05, 1.7507e-04, 2.0122e-04, 0, 0, 0));
	calcn_r = new OpenSim::Body("calcn_r", 0.4217, Vec3(0.03628, 0.017101, -0.004057), Inertia(8.5663e-05, 1.7507e-04, 2.0122e-04, 0, 0, 0));
	metatarsi_l = new OpenSim::Body("metatarsi_l", 0.5417, Vec3(0.03937, -0.01465, -0.0018528), Inertia(0.0013620, 0.002204, 0.0019264, 0, 0, 0));
	metatarsi_r = new OpenSim::Body("metatarsi_r", 0.5417, Vec3(0.03937, -0.01465, 0.0018528), Inertia(0.0013620, 0.002204, 0.0019264, 0, 0, 0));
	...
	midtarsal_l = new PinJoint("midtarsal_l", *calcn_l, Vec3(0.078023, 0.025452, 0.0068103), Vec3(0), *metatarsi_l, Vec3(0), Vec3(0));
	midtarsal_r = new PinJoint("midtarsal_r", *calcn_r, Vec3(0.078023, 0.025452, -0.0068103), Vec3(0), *metatarsi_r, Vec3(0), Vec3(0));
	mtp_l = new PinJoint("mtp_l", *metatarsi_l, Vec3(0.0853859, -0.02728, -0.00779737), Vec3(0), *toes_l, Vec3(0), Vec3(0));
	mtp_r = new PinJoint("mtp_r", *metatarsi_r, Vec3(0.0853859, -0.02728, 0.00779737), Vec3(0), *toes_r, Vec3(0), Vec3(0));
	...
	Vec3 locSphere_3_r(0.0567, -0.035452, 0.027993);
	Vec3 locSphere_4_r(0.0567, -0.035452, -0.00318967);

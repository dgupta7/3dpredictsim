...
int F_generic(const T** arg, T** res) {
	...
	/// left
	osim_double_adouble E_HC_1_l_y = HC_1_l->calcPotentialEnergy(*state);
	osim_double_adouble E_HC_2_l_y = HC_2_l->calcPotentialEnergy(*state);
	osim_double_adouble E_HC_3_l_y = HC_3_l->calcPotentialEnergy(*state);
	osim_double_adouble E_HC_4_l_y = HC_4_l->calcPotentialEnergy(*state);
	osim_double_adouble E_HC_5_l_y = HC_5_l->calcPotentialEnergy(*state);
	osim_double_adouble E_HC_6_l_y = HC_6_l->calcPotentialEnergy(*state);
    /// per foot segment
	...
	/// right
	osim_double_adouble E_HC_1_r_y = HC_1_r->calcPotentialEnergy(*state);
	osim_double_adouble E_HC_2_r_y = HC_2_r->calcPotentialEnergy(*state);
	osim_double_adouble E_HC_3_r_y = HC_3_r->calcPotentialEnergy(*state);
	osim_double_adouble E_HC_4_r_y = HC_4_r->calcPotentialEnergy(*state);
	osim_double_adouble E_HC_5_r_y = HC_5_r->calcPotentialEnergy(*state);
	osim_double_adouble E_HC_6_r_y = HC_6_r->calcPotentialEnergy(*state);
    /// per foot segment

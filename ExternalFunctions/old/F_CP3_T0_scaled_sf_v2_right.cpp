...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::Body* pelvis;
	pelvis = new OpenSim::Body("pelvis", 2.98702807898706668155, Vec3(-0.05495243893423943510, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.01575189694371807031, 0.01334620840270276006, 0.00887193417355327044, 0., 0., 0.));
	model->addBody(pelvis);

	OpenSim::Body* femur_r;
	femur_r = new OpenSim::Body("femur_r", 4.10040865105042406924, Vec3(0.00000000000000000000, -0.15886974915540982844, 0.00000000000000000000), Inertia(0.05155181660259277460, 0.01351358299291267016, 0.05436233386322703032, 0., 0., 0.));
	model->addBody(femur_r);

	OpenSim::Body* tibia_r;
	tibia_r = new OpenSim::Body("tibia_r", 1.48146372637515955084, Vec3(0.00000000000000000000, -0.16885488160531622603, 0.00000000000000000000), Inertia(0.01647323918893485450, 0.00166693491792793192, 0.01670203417767006024, 0., 0., 0.));
	model->addBody(tibia_r);

	OpenSim::Body* talus_r;
	talus_r = new OpenSim::Body("talus_r", 0.03829407072169324633, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00030447473092998770, 0.00030447473092998770, 0.00030447473092998770, 0., 0., 0.));
	model->addBody(talus_r);

	OpenSim::Body* calcn_r;
	calcn_r = new OpenSim::Body("calcn_r", 0.47867588402116562074, Vec3(0.08916817132865714757, 0.02675045139859714288, 0.00000000000000000000), Inertia(0.00042626462330198276, 0.00118745145062695216, 0.00124834639681294969, 0., 0., 0.));
	model->addBody(calcn_r);

	OpenSim::Body* toes_r;
	toes_r = new OpenSim::Body("toes_r", 0.05299662054629880603, Vec3(0.02657288382104061250, 0.00460801453544056831, -0.01344004239503499357), Inertia(0.00001443161399893519, 0.00002886322799787038, 0.00001443161399893519, 0., 0., 0.));
	model->addBody(toes_r);

	OpenSim::Body* femur_l;
	femur_l = new OpenSim::Body("femur_l", 4.10040865105042406924, Vec3(0.00000000000000000000, -0.15886974915540982844, 0.00000000000000000000), Inertia(0.05155181660259277460, 0.01351358299291267016, 0.05436233386322703032, 0., 0., 0.));
	model->addBody(femur_l);

	OpenSim::Body* tibia_l;
	tibia_l = new OpenSim::Body("tibia_l", 1.48146372637515955084, Vec3(0.00000000000000000000, -0.16885488160531622603, 0.00000000000000000000), Inertia(0.01647323918893485450, 0.00166693491792793192, 0.01670203417767006024, 0., 0., 0.));
	model->addBody(tibia_l);

	OpenSim::Body* talus_l;
	talus_l = new OpenSim::Body("talus_l", 0.03829407072169324633, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00030447473092998770, 0.00030447473092998770, 0.00030447473092998770, 0., 0., 0.));
	model->addBody(talus_l);

	OpenSim::Body* calcn_l;
	calcn_l = new OpenSim::Body("calcn_l", 0.47867588402116562074, Vec3(0.08916817132865714757, 0.02675045139859714288, 0.00000000000000000000), Inertia(0.00042626462330198276, 0.00118745145062695216, 0.00124834639681294969, 0., 0., 0.));
	model->addBody(calcn_l);

	OpenSim::Body* toes_l;
	toes_l = new OpenSim::Body("toes_l", 0.05299662054629880603, Vec3(0.02657288382104061250, 0.00460801453544056831, 0.01344004239503499357), Inertia(0.00001443161399893519, 0.00002886322799787038, 0.00001443161399893519, 0., 0., 0.));
	...
	osim_double_adouble st_knee_r_3_coeffs[7] = {0.00020019312668219700, -0.00004342809318353370, -0.00197263204615022014, 0.00141309985321285011, 0.00475407363987020038, -0.00583233119053085981, -0.00372274627555158012}; 
	Vector st_knee_r_3_coeffs_vec(7); 
	for (int i = 0; i < 7; ++i) st_knee_r_3_coeffs_vec[i] = st_knee_r_3_coeffs[i]; 
	...
	osim_double_adouble st_knee_r_4_coeffs[5] = {0.00053025986957570403, 0.00062581959526487603, -0.00522076821592231972, 0.00318996474681814985, -0.36980526921430700860}; 
	...
	st_knee_r[5].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.93452793620829299748));
	...
	st_ankle_r[3].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.90441821963211688207));
	st_ankle_r[3].setAxis(Vec3(1.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	st_ankle_r[4].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.90441821963211688207));
	st_ankle_r[4].setAxis(Vec3(0.00000000000000000000, 1.00000000000000000000, 0.00000000000000000000));
	st_ankle_r[5].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.90441821963211688207));
	...
	ankle_r = new OpenSim::CustomJoint("ankle_r", *tibia_r, Vec3(0.00000000000000000000, -0.38889983444181025485, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *talus_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_ankle_r);
	...
	subtalar_r = new OpenSim::CustomJoint("subtalar_r", *talus_r, Vec3(-0.04348731715698608835, -0.03740604787237167272, 0.00706211916922964544), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *calcn_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_subtalar_r);

	OpenSim::PinJoint* mtp_r;
	mtp_r = new OpenSim::PinJoint("mtp_r", *calcn_r, Vec3(0.15943269033563894910, -0.00178336342657314296, 0.00096301625034949712), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *toes_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	osim_double_adouble st_knee_l_3_coeffs[7] = {0.00020019312668219700, -0.00004342809318353370, -0.00197263204615022014, 0.00141309985321285011, 0.00475407363987020038, -0.00583233119053085981, -0.00372274627555158012}; 
	Vector st_knee_l_3_coeffs_vec(7); 
	for (int i = 0; i < 7; ++i) st_knee_l_3_coeffs_vec[i] = st_knee_l_3_coeffs[i]; 
	...
	osim_double_adouble st_knee_l_4_coeffs[5] = {0.00053025986957570403, 0.00062581959526487603, -0.00522076821592231972, 0.00318996474681814985, -0.36980526921430700860}; 
	...
	st_knee_l[5].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.93452793620829299748));
	...
	st_ankle_l[3].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.91820610282950809733));
	st_ankle_l[3].setAxis(Vec3(1.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	st_ankle_l[4].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.91820610282950809733));
	st_ankle_l[4].setAxis(Vec3(0.00000000000000000000, 1.00000000000000000000, 0.00000000000000000000));
	st_ankle_l[5].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.91820610282950809733));
	...
	ankle_l = new OpenSim::CustomJoint("ankle_l", *tibia_l, Vec3(0.00000000000000000000, -0.38889983444181025485, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *talus_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_ankle_l);
	...
	st_subtalar_l[3].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.86787155221187450849));
	st_subtalar_l[3].setAxis(Vec3(1.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	st_subtalar_l[4].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.86787155221187450849));
	st_subtalar_l[4].setAxis(Vec3(0.00000000000000000000, 1.00000000000000000000, 0.00000000000000000000));
	st_subtalar_l[5].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.86787155221187450849));
	...
	subtalar_l = new OpenSim::CustomJoint("subtalar_l", *talus_l, Vec3(-0.04348731715698608835, -0.03740604787237167272, -0.00706211916922964544), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *calcn_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_subtalar_l);

	OpenSim::PinJoint* mtp_l;
	mtp_l = new OpenSim::PinJoint("mtp_l", *calcn_l, Vec3(0.15943269033563894910, -0.00178336342657314296, -0.00096301625034949712), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *toes_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	st_back[3].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.77726221972050124620));
	st_back[3].setAxis(Vec3(1.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	st_back[4].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.77726221972050124620));
	st_back[4].setAxis(Vec3(0.00000000000000000000, 1.00000000000000000000, 0.00000000000000000000));
	st_back[5].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.77726221972050124620));
	st_back[5].setAxis(Vec3(0.00000000000000000000, 0.00000000000000000000, 1.00000000000000000000));
	OpenSim::CustomJoint* back;
	back = new OpenSim::CustomJoint("back", *pelvis, Vec3(-0.07827030552585446943, 0.06334687090722085356, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *torso, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_back);

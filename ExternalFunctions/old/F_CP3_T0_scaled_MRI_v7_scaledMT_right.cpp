...
int F_generic(const T** arg, T** res) {
	...
	femur_l = new OpenSim::Body("femur_l", 4.23004499999999961091, Vec3(0.00000000000000000000, -0.15564800000000000857, 0.00000000000000000000), Inertia(0.07180040000000000033, 0.01472689999999999937, 0.07180040000000000033, 0., 0., 0.));
	model->addBody(femur_l);

	OpenSim::Body* tibia_l;
	tibia_l = new OpenSim::Body("tibia_l", 1.30549500000000007205, Vec3(0.00000000000000000000, -0.16083700000000000774, 0.00000000000000000000), Inertia(0.01205960000000000018, 0.00207310999999999997, 0.01255490000000000078, 0., 0., 0.));
	model->addBody(tibia_l);

	OpenSim::Body* talus_l;
	talus_l = new OpenSim::Body("talus_l", 0.01808999999999999844, Vec3(0.00440338000000000014, 0.00184140999999999992, 0.00000000000000000000), Inertia(0.00000120600000000000, 0.00000040200000000000, 0.00000120600000000000, 0., 0., 0.));
	model->addBody(talus_l);

	OpenSim::Body* calcn_l;
	calcn_l = new OpenSim::Body("calcn_l", 0.35576999999999997515, Vec3(0.08155460000000000487, 0.01248960000000000001, 0.00000000000000000000), Inertia(0.00036541800000000000, 0.00093022799999999996, 0.00107857000000000005, 0., 0., 0.));
	model->addBody(calcn_l);

	OpenSim::Body* toes_l;
	toes_l = new OpenSim::Body("toes_l", 0.03919500000000000067, Vec3(0.02457890000000000075, -0.00208159999999999986, -0.00840600000000000028), Inertia(0.00004020000000000000, 0.00010251000000000001, 0.00011818800000000000, 0., 0., 0.));
	...
	hip_l = new OpenSim::CustomJoint("hip_l", *pelvis, Vec3(-0.04222469999999999696, -0.06806529999999999525, -0.06662780000000000091), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *femur_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_hip_l);
	...
	osim_double_adouble st_knee_l_3_coeffs[5] = {0.00006005791761497840, 0.00135950546184407991, -0.00072518845200059297, -0.00749669033614245965, 0.00000997842077021019}; 
	...
	osim_double_adouble st_knee_l_4_coeffs[5] = {0.00147265727666488007, 0.00477958776428671038, 0.00239627589314217980, 0.00219767845231851012, -0.37585203093087299342}; 
	...
	subtalar_l = new OpenSim::CustomJoint("subtalar_l", *talus_l, Vec3(-0.03904599999999999738, -0.03358599999999999780, -0.00634100000000000028), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *calcn_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_subtalar_l);

	OpenSim::PinJoint* mtp_l;
	mtp_l = new OpenSim::PinJoint("mtp_l", *calcn_l, Vec3(0.14154900000000000815, -0.00160099999999999999, -0.00086499999999999999), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *toes_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));

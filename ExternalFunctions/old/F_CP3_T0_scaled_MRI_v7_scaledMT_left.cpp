...
int F_generic(const T** arg, T** res) {
	...
	femur_r = new OpenSim::Body("femur_r", 4.23004499999999961091, Vec3(0.00000000000000000000, -0.15508199999999999763, 0.00000000000000000000), Inertia(0.07180040000000000033, 0.01472689999999999937, 0.07180040000000000033, 0., 0., 0.));
	model->addBody(femur_r);

	OpenSim::Body* tibia_r;
	tibia_r = new OpenSim::Body("tibia_r", 1.30549500000000007205, Vec3(0.00000000000000000000, -0.16085900000000000198, 0.00000000000000000000), Inertia(0.01205960000000000018, 0.00207310999999999997, 0.01255490000000000078, 0., 0., 0.));
	model->addBody(tibia_r);

	OpenSim::Body* talus_r;
	talus_r = new OpenSim::Body("talus_r", 0.01808999999999999844, Vec3(0.00439128999999999995, 0.00183635999999999999, 0.00000000000000000000), Inertia(0.00000120600000000000, 0.00000040200000000000, 0.00000120600000000000, 0., 0., 0.));
	model->addBody(talus_r);

	OpenSim::Body* calcn_r;
	calcn_r = new OpenSim::Body("calcn_r", 0.35576999999999997515, Vec3(0.08133070000000000577, 0.01245530000000000075, 0.00000000000000000000), Inertia(0.00036541800000000000, 0.00093022799999999996, 0.00107857000000000005, 0., 0., 0.));
	model->addBody(calcn_r);

	OpenSim::Body* toes_r;
	toes_r = new OpenSim::Body("toes_r", 0.03919500000000000067, Vec3(0.02451139999999999916, -0.00207588000000000000, 0.00838299999999999983), Inertia(0.00004020000000000000, 0.00010251000000000001, 0.00011818800000000000, 0., 0., 0.));
	...
	osim_double_adouble st_knee_r_3_coeffs[5] = {0.00001608375257708350, 0.00105086065965212007, -0.00098236942047144008, -0.00705537532565546962, 0.00000125145933669088}; 
	...
	osim_double_adouble st_knee_r_4_coeffs[5] = {0.00186209782661609009, 0.00604997570007316000, 0.00313928078989176001, 0.00264056900790299006, -0.37843180347954197273}; 
	...
	ankle_r = new OpenSim::CustomJoint("ankle_r", *tibia_r, Vec3(0.00000000000000000000, -0.36070000000000002061, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *talus_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_ankle_r);
	...
	subtalar_r = new OpenSim::CustomJoint("subtalar_r", *talus_r, Vec3(-0.03893900000000000139, -0.03349400000000000294, 0.00632299999999999963), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *calcn_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_subtalar_r);

	OpenSim::PinJoint* mtp_r;
	mtp_r = new OpenSim::PinJoint("mtp_r", *calcn_r, Vec3(0.14116000000000000769, -0.00159699999999999990, 0.00086200000000000003), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *toes_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));

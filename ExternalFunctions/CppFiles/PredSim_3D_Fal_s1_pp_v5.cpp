...
constexpr int NR = ndof + 6 + 5 * 6 + 6 + 6 + 18 + 12 + 6 + 6;   // # residual torques + joint origins + residual torques 
										// + talus + separate GRFs + separate GRF torques + ankle axis + GRF power
...
int F_generic(const T** arg, T** res) {
	...
	osim_double_adouble P_HC_1_l_y = v_HC_1_l[1]*GRF_1_l[1];
	osim_double_adouble P_HC_2_l_y = v_HC_2_l[1]*GRF_2_l[1];
	osim_double_adouble P_HC_3_l_y = v_HC_3_l[1]*GRF_3_l[1];
	osim_double_adouble P_HC_4_l_y = v_HC_4_l[1]*GRF_4_l[1];
	osim_double_adouble P_HC_5_l_y = v_HC_5_l[1]*GRF_5_l[1];
	osim_double_adouble P_HC_6_l_y = v_HC_6_l[1]*GRF_6_l[1];
	/// per foot segment
	...
	/// power vertical deformation left
	osim_double_adouble P_HC_1_r_y = v_HC_1_r[1]*GRF_1_r[1];
	osim_double_adouble P_HC_2_r_y = v_HC_2_r[1]*GRF_2_r[1];
	osim_double_adouble P_HC_3_r_y = v_HC_3_r[1]*GRF_3_r[1];
	osim_double_adouble P_HC_4_r_y = v_HC_4_r[1]*GRF_4_r[1];
	osim_double_adouble P_HC_5_r_y = v_HC_5_r[1]*GRF_5_r[1];
	osim_double_adouble P_HC_6_r_y = v_HC_6_r[1]*GRF_6_r[1];
	/// per foot segment

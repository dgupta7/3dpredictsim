...
int F_generic(const T** arg, T** res) {
	...
	st_subtalar_r[0].setAxis(Vec3(0.698242, 0.71325, -0.061088));
	...
	subtalar_r = new CustomJoint("subtalar_r", *talus_r, Vec3(-0.0445721, (-0.05145 + 0.0059219), (0.00723828 - 0.003338735)), Vec3(0), *calcn_r, Vec3(0, 0.0059219, -0.003338735), Vec3(0), st_subtalar_r);
	// axis has to pass through talus origin => add offset distances to both parent and child frame, to preserve location of calcaneus origin

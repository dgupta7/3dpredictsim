...
constexpr int ndof = 22;           // # degrees of freedom (excluding locked)
constexpr int ndofr = ndof;    // # degrees of freedom (including locked)
constexpr int NX = ndof * 2;       // # states
constexpr int NU = ndof;           // # controls
constexpr int NR = ndof + 5 * 3;   // # joint origins + GRFs
...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::CustomJoint* ground_heel; // Heel is stripped to the bone.
	OpenSim::CustomJoint* ground_forefoot; // Simplified ground contact
	...
	st_ground_tibia[0].setCoordinateNames(OpenSim::Array<std::string>("tibia_rx", 1, 1));
	st_ground_tibia[0].setFunction(new LinearFunction());
	st_ground_tibia[0].setAxis(Vec3(1, 0, 0));
	st_ground_tibia[1].setCoordinateNames(OpenSim::Array<std::string>("tibia_ry", 1, 1));
	st_ground_tibia[1].setFunction(new LinearFunction());
	st_ground_tibia[1].setAxis(Vec3(0, 1, 0));
	st_ground_tibia[2].setCoordinateNames(OpenSim::Array<std::string>("tibia_rz", 1, 1));
	st_ground_tibia[2].setFunction(new LinearFunction());
	st_ground_tibia[2].setAxis(Vec3(0, 0, 1));
	...
	/// Ground-Calcn transform
	SpatialTransform st_ground_heel;
	st_ground_heel[0].setCoordinateNames(OpenSim::Array<std::string>("heel_rx", 1, 1));
	st_ground_heel[0].setFunction(new LinearFunction());
	st_ground_heel[0].setAxis(Vec3(1, 0, 0));
	st_ground_heel[1].setCoordinateNames(OpenSim::Array<std::string>("heel_ry", 1, 1));
	st_ground_heel[1].setFunction(new LinearFunction());
	st_ground_heel[1].setAxis(Vec3(0, 1, 0));
	st_ground_heel[2].setCoordinateNames(OpenSim::Array<std::string>("heel_rz", 1, 1));
	st_ground_heel[2].setFunction(new LinearFunction());
	st_ground_heel[2].setAxis(Vec3(0, 0, 1));
	st_ground_heel[3].setCoordinateNames(OpenSim::Array<std::string>("heel_tx", 1, 1));
	st_ground_heel[3].setFunction(new LinearFunction());
	st_ground_heel[3].setAxis(Vec3(1, 0, 0));
	st_ground_heel[4].setCoordinateNames(OpenSim::Array<std::string>("heel_ty", 1, 1));
	st_ground_heel[4].setFunction(new LinearFunction());
	st_ground_heel[4].setAxis(Vec3(0, 1, 0));
	st_ground_heel[5].setCoordinateNames(OpenSim::Array<std::string>("heel_tz", 1, 1));
	st_ground_heel[5].setFunction(new LinearFunction());
	st_ground_heel[5].setAxis(Vec3(0, 0, 1));
	/// Ground-Forefoot transform
	SpatialTransform st_ground_forefoot;
	st_ground_forefoot[0].setCoordinateNames(OpenSim::Array<std::string>("forefoot_rx", 1, 1));
	st_ground_forefoot[0].setFunction(new LinearFunction());
	st_ground_forefoot[0].setAxis(Vec3(1, 0, 0));
	st_ground_forefoot[1].setCoordinateNames(OpenSim::Array<std::string>("forefoot_ry", 1, 1));
	st_ground_forefoot[1].setFunction(new LinearFunction());
	st_ground_forefoot[1].setAxis(Vec3(0, 1, 0));
	st_ground_forefoot[2].setCoordinateNames(OpenSim::Array<std::string>("forefoot_rz", 1, 1));
	st_ground_forefoot[2].setFunction(new LinearFunction());
	st_ground_forefoot[2].setAxis(Vec3(0, 0, 1));
	st_ground_forefoot[3].setCoordinateNames(OpenSim::Array<std::string>("forefoot_tx", 1, 1));
	st_ground_forefoot[3].setFunction(new LinearFunction());
	st_ground_forefoot[3].setAxis(Vec3(1, 0, 0));
	st_ground_forefoot[4].setCoordinateNames(OpenSim::Array<std::string>("forefoot_ty", 1, 1));
	st_ground_forefoot[4].setFunction(new LinearFunction());
	st_ground_forefoot[4].setAxis(Vec3(0, 1, 0));
	st_ground_forefoot[5].setCoordinateNames(OpenSim::Array<std::string>("forefoot_tz", 1, 1));
	st_ground_forefoot[5].setFunction(new LinearFunction());
	st_ground_forefoot[5].setAxis(Vec3(0, 0, 1));

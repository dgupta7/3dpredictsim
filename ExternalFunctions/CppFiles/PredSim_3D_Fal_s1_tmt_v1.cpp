...
int F_generic(const T** arg, T** res) {
    ...
    calcn_l = new OpenSim::Body("calcn_l", 0.605702736125806, Vec3(0.066907031412174, 0.033043440839674, 0.000206410626306), Inertia(0.000640470075250077, 0.000803602321664157, 0.000963648343440358, 0, 0, 0));
    calcn_r = new OpenSim::Body("calcn_r", 0.605702736125806, Vec3(0.066907031412174, 0.033043440839674, -0.000206410626306), Inertia(0.000640470075250077, 0.000803602321664157, 0.000963648343440358, 0, 0, 0));
	metatarsi_l = new OpenSim::Body("metatarsi_l", 0.332841848859467, Vec3(0.027675743715505, -0.018380814192906, 0.000077084485412), Inertia(0.0001834, 0.0006182, 0.00052960, 0, 0, 0));
	metatarsi_r = new OpenSim::Body("metatarsi_r", 0.332841848859467, Vec3(0.027675743715505, -0.018380814192906, -0.000077084485412), Inertia(0.0001834, 0.0006182, 0.00052960, 0, 0, 0));

...
constexpr int NR = ndof + 6 + 6 + 18 + 6 + 6 + 18 + 6 + 6 ;   // # residual torques + # GRFs 
	// + # joint origins + # separate GRFs + GRF torques + talus origin + separate GRF torques + ankle axis + GRF power
...
int F_generic(const T** arg, T** res) {
	...
	osim_double_adouble stiffness = 2000000;

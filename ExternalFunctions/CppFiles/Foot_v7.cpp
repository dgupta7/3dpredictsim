...
int F_generic(const T** arg, T** res) {
	...
	st_ground_tibia[0].setCoordinateNames(OpenSim::Array<std::string>("tibia_rz", 1, 1));
	...
	// States and controls
	T ua[ndof]; /// joint accelerations (Qdotdots) - controls

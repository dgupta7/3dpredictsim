...
osim_double_adouble ExoAngularVelocity(Model& model, const OpenSim::Body& bodyA, const OpenSim::Body& bodyB, State& s, const Vec3& ExoTorque) {
	...
	*/
	osim_double_adouble ExoAngVel = Exo_Vel.get(2);
...
int F_generic(const T** arg, T** res) {
	...
	Vec3 COMCalcn_r = Vec3(0.036283, 0.017101, -0.004057);
	...
	osim_double_adouble mCalcn = 0.40857;
	Vec3 ITibia = Vec3(0.0356624, 0.00360871, 0.0361578);
	Inertia ITalus(0.000647371, 0.000647371, 0.000647371, 0, 0, 0);
	Vec3 ICalcn = Vec3(8.2986e-05, 0.0001696, 0.00019494);
	Vec3 dSubtalar = Vec3(-0.044572100000000003, -0.038339100000000001, 0.0072382799999999997);
	...
	osim_double_adouble mFoot_tot = mCalcn + mFoot_Exo;
	Vec3 COM_TibNew, COM_FootNew_r, COM_FootNew_l;
	osim_double_adouble COMs;
	for (int i = 0; i < 3; ++i) {
		COMs = (COMShank_Exo.get(i)*mShank_Exo + COMTibia.get(i)*mTibia) / mTib_tot;
		COM_TibNew.set(i, COMs);
		COMs = (COMFoot_Exo.get(i)*mFoot_Exo + COMCalcn_r.get(i)*mCalcn) / mFoot_tot;
		COM_FootNew_r.set(i, COMs);
		COM_FootNew_l.set(i, COMs);
	}
	COM_FootNew_l.set(2, -COMs);

	// Get the new inertia: x -axis	
	osim_double_adouble dTibia, dExoShank, dFoot, dExoFoot;
	...
	dFoot = sqrt(pow(COM_FootNew_r.get(1) - COMCalcn_r.get(1), 2) + pow(COM_FootNew_r.get(2) - COMCalcn_r.get(2), 2));
	dExoFoot = sqrt(pow(COM_FootNew_r.get(1) - COMFoot_Exo.get(1), 2) + pow(COM_FootNew_r.get(2) - COMFoot_Exo.get(2), 2));
	osim_double_adouble IFootTotalx = IFootExo.get(0) + mFoot_Exo * pow(dExoFoot, 2) + ICalcn.get(0) + mCalcn * pow(dFoot, 2);
	...
	dFoot = sqrt(pow(COM_FootNew_r.get(0) - COMCalcn_r.get(0), 2) + pow(COM_FootNew_r.get(2) - COMCalcn_r.get(2), 2));
	dExoFoot = sqrt(pow(COM_FootNew_r.get(0) - COMFoot_Exo.get(0), 2) + pow(COM_FootNew_r.get(2) - COMFoot_Exo.get(2), 2));
	osim_double_adouble IFootTotaly = IFootExo.get(1) + mFoot_Exo * pow(dExoFoot, 2) + ICalcn.get(1) + mCalcn * pow(dFoot, 2);
	...
	dFoot = sqrt(pow(COM_FootNew_r.get(0) - COMCalcn_r.get(0), 2) + pow(COM_FootNew_r.get(1) - COMCalcn_r.get(1), 2));
	dExoFoot = sqrt(pow(COM_FootNew_r.get(0) - COMFoot_Exo.get(0), 2) + pow(COM_FootNew_r.get(1) - COMFoot_Exo.get(1), 2));
	osim_double_adouble IFootTotalz = IFootExo.get(2) + mFoot_Exo * pow(dExoFoot, 2) + ICalcn.get(2) + mCalcn * pow(dFoot, 2);
	...
	calcn_l = new OpenSim::Body("calcn_l", mFoot_tot, COM_FootNew_l, IFootNew);
	calcn_r = new OpenSim::Body("calcn_r", mFoot_tot, COM_FootNew_r, IFootNew);

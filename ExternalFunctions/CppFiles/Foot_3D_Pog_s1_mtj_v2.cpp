...
int F_generic(const T** arg, T** res) {
	...
	calcn_r = new OpenSim::Body("calcn_r", 0.4217, Vec3(0.0508, 0.0219, 9.0388e-05), Inertia(8.5663e-05, 1.7507e-04, 2.0122e-04, 0, 0, 0));
	central_foot_r = new OpenSim::Body("central_foot_r", 0.5417, Vec3(0.0349, -0.0389, 3.2937e-04), Inertia(7.9767e-04, 0.001121, 0.001201, 0, 0, 0));
	...
	midtarsal_r = new PinJoint("midtarsal_r", *calcn_r, Vec3(0.0878, 0.0706, -3.9905e-04), Vec3(0), *central_foot_r, Vec3(0), Vec3(0));
	mtp_r = new PinJoint("mtp_r", *central_foot_r, Vec3(0.0756, -0.0724, 0.001386), Vec3(0), *toes_r, Vec3(0), Vec3(0));
	...
	Vec3 locSphere_3_r(0.0772, -0.0806, 0.0216);
	Vec3 locSphere_4_r(0.0772, -0.0806, -0.0096);

...
constexpr int NR = ndof + 6 + 6 + 18 + 6 + 6 + 18 + 6 + 6;   // # residual torques + # GRFs + # joint origins + # separate GRFs 
							// + GRF torques + talus origin + separate GRF torques + ankle axis + GRF power

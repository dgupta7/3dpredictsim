...
%         func = @(vars) full(fs(vars,Qs_mtp(i),Fs_tib(j)));
%         x = fsolve(func,vars_init);
        ...
        Qs(i,j,jointfi.ankle.r) = x(1);
        Qs(i,j,jointfi.subt.r) = x(2);
        Qs(i,j,jointfi.tmt.r) = x(3);
        Qs(i,j,jointfi.tibia.rz) = x(4);
        Qs(i,j,jointfi.tibia.ty) = x(5);
